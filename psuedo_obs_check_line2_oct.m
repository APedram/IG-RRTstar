function issue_flag = psuedo_obs_check_line2_oct(node_ii, node_jj, obstacle_edge, R, chi, bound, num_props, prop)
...
%% check losslessness 
not_lossless = check_lossless( node_ii.x, node_ii.P, node_jj.x, node_jj.P, R );
...
% initial and final position of connecting line segmen from node_ii to node_jj
x0 = node_ii.x;
xF = node_jj.x;
...
% compute the covarinace  and major axis before measurement at node_jj
